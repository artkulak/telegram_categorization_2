...
static std::string get_valid_language_code(std::string code) noexcept
{
...
static std::vector<std::pair<real, std::string>> get_category_predictions() noexcept
{
...
static void populate_category_probabilites(const std::vector<std::pair<real, std::string>> &predictions,
...
static void detect_category(const TelegramChannelInfo *channel_info,
                            double category_probability[TGCAT_CATEGORY_OTHER + 1])
{
  (void)channel_info;
...
namespace UseCase__Complete
{
  ...
  static void detect_language(const TelegramChannelInfo *channel_info,
